...
function GM.PlayerRegistration ( Player, Cmd, Args )
	...
	DataBase:Query("SELECT `ID_MEMBER` FROM `SMF_MEMBERS` WHERE `memberName` LIKE '" .. tmysql.escape(UN) .. "'", function ( PlayerInfo )
	...
	DataBase:Query("INSERT INTO `smf_members_pending` VALUES ('" .. tmysql.escape(UN) .. "', '" .. tmysql.escape(Player:Nick()) .. "', '" .. Player:SteamID() .. "', '" .. tmysql.escape(PW) .. "', '" .. SetRank .. "', '" .. Player:IPAddress() .. "')", function ( Res )
...
function GM.PlayerRegistration ( Player, Cmd, Args )
	...
	DataBase:Query("INSERT INTO `smf_members_change_pw` VALUES ('" .. PW .. "', '" .. Player:SteamID() .. "')", function ( p )
