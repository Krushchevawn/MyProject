...
GM.MaximumBusDrivers = 1;
GM.PeopleRequired_Mayor = 0;
GM.MaximumRoadService = 2
...
if SERVER then
	function GM.SendJobInformation ( plOverride )
		...
		timer.Simple(1, function() GAMEMODE.SendJobInformation2() end)
	end
	...
	function GM.SendJobInformation2 ( plOverride )
		...
		timer.Simple(1, function() GAMEMODE.SendJobInformation3() end)
	end
...
timer.Create("GM.CalculateMaxJobss", 5, 0, function() GAMEMODE.CalculateMaxJobss() end)
