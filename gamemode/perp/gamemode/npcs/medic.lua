...
NPC.Model = Model(PERPGetModelPath(2, 1, 6))

NPC.Invisible = false; // Used for ATM Machines, Casino Tables, etc.

NPC.Location = Vector(-9851.7021, 9363.1406, 72.0313);
NPC.Angles = Angle(0, 1.488, 0);
...
local NumberOfMedics = team.NumPlayers(TEAM_MEDIC);
	...
	if NumberOfMedics > 0 then
		...
		GAMEMODE.DialogPanel:SetDialog("Hi, im the local medic. I can heal you to full health or fix a broken leg.");
