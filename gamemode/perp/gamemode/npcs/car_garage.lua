...
NPC.Location = Vector(-5391.2427, -10296.3262, 71.0313);
...
function NPC.OnTalk ( )
	...
	if (LocalPlayer():Team() == TEAM_CITIZEN) then
		GAMEMODE.DialogPanel:AddDialog("Yes, I've come to claim my car.", NPC.NewCar)
		//GAMEMODE.DialogPanel:AddDialog("I want to change cars, please.", NPC.ClaimCar)
