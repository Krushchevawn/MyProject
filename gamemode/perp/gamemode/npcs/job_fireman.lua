...
NPC.Angles = Angle(0, 180, 0.000000);
...
function NPC.Hire ( )
	...
	elseif (LocalPlayer():GetTimePlayed() < GAMEMODE.RequiredTime_Fire * 60 * 60 && !LocalPlayer():IsVIP()) then
...
function NPC.FireTruck ( )
	...
	for k, v in pairs(ents.FindByClass("prop_vehicle_jeep")) do
		...
		if (vT && vT.RequiredClass == TEAM_FIREMAN && v:GetSharedEntity("owner", nil) != LocalPlayer()) then
