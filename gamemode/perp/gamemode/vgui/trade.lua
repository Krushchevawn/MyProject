...
function PANEL:Init ( )
	...
	self.invPanel = vgui.Create("perp2_trade_inv", self);
end
...
function PANEL:PerformLayout ( )	
	...
	self.invPanel.SizeOfBlock = sizeOfBlock;
	self.invPanel:SetSize(NeededW, NeededH);
	self.invPanel:SetPos(startX, startY);
