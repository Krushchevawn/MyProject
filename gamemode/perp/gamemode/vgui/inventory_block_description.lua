...
function PANEL:Paint ( )
	...
	if (self.itemTable) then
		...
		cost = cost + (cost * GAMEMODE.GetTaxRate_Sales())
		
		draw.SimpleText("Buy Price: "  .. DollarSign() .. cost .. " (" .. GAMEMODE.GetTaxRate_Sales_Text() .. " sales tax)", "DefaultSmall", self:GetWide() * .5, curY, Color(255, 255, 255, self.ourAlpha), 1, 1)
