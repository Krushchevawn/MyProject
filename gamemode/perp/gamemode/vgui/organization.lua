...
function PANEL:Init ( )
	...
	local orgID = LocalPlayer():GetSharedInt("org", 0);
...
function PANEL:Setup ( )
	...
	if (GAMEMODE.OrganizationData[orgID][4]) then
		...
		for k, v in pairs(player.GetAll()) do
			if (v:GetSharedInt("org", 0) == 0) then
...
function PANEL:Paint ( )
	...
	if (LocalPlayer():GetSharedInt("org", 0) == 0) then
		...
		return;
	elseif (GAMEMODE.OrganizationData && GAMEMODE.OrganizationData[LocalPlayer():GetSharedInt("org", 0)] && GAMEMODE.OrganizationData[LocalPlayer():GetSharedInt("org", 0)][4]) then
		draw.SimpleText("MOTD: " .. GAMEMODE.OrganizationData[LocalPlayer():GetSharedInt("org", 0)][2], "Default", self:GetWide() * .5, 27, Color(200, 200, 200, 255), 1);
		draw.SimpleText("Owner: " .. GAMEMODE.OrganizationData[LocalPlayer():GetSharedInt("org", 0)][3], "Default", self:GetWide() * .5, 39, Color(200, 200, 200, 255), 1);
	elseif (!rodUs || rodUs != LocalPlayer():GetSharedInt("org", 0)) then
		rodUs = LocalPlayer():GetSharedInt("org", 0)
		RunConsoleCommand("perp_rod", tostring(LocalPlayer():GetSharedInt("org", 0)))
	end
end
