...
local hints = 	{
					...
					"Like our servers? Consider donating at GENERIC.net.",
					"Find a bug? Report it at GENERIC.net.",
					"Snow makes handling a car more difficult. Increase your driving skill to make it easier.",
					"If you are experiencing crashing, try lowering your shadow detail to medium.",
					"To close the shop menu, press F2.",
					"You can install the BASS module by downloading the necessary files from GENERIC.net.",
				};
