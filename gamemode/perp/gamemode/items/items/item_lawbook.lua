...
if SERVER then
	...
	function ITEM.OnUse ( slotID )
		...
		Traffic Ticket Price: $]] .. GetSharedInt("ticket_price") .. [[<br>
		Inner City Speedlimit: ]] .. GetSharedInt("innercity_speedlimit_i") .. [[ MPH<br>
		Outter City Speedlimit: ]] .. GetSharedInt("innercity_speedlimit_o") .. [[ MPH<br>
