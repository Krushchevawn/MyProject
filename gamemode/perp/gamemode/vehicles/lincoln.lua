...
VEHICLE.PaintJobs = {
						...
						{model = 'models/sickness/1972markiv.mdl', skin = '6', name = 'Brown', color = Color(155, 131, 91, 255)},
						{model = 'models/sickness/1972markiv.mdl', skin = '7', name = 'Silver', color = Color(96, 99, 96, 255)},
...
VEHICLE.Exhaust = { 
									{Vector(-12.8999, -118.3662, 23.7669), Angle(0, 0, 80)},
									{Vector(12.8999, -118.3662, 23.7669), Angle(0, 0, 80)},
						}
