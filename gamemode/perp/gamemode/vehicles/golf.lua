...
VEHICLE.PaintJobs = {
						...
						/*{	model = 'models/golf/golf.mdl', skin = '3', 	name = 'Red', 		color = Color(255, 0, 0, 255)		},
						{	model = 'models/golf/golf.mdl', skin = '4', 	name = 'Yellow', 	color = Color(227, 214, 0, 255)		},
						{	model = 'models/golf/golf.mdl', skin = '5', 	name = 'Black', 	color = Color(0, 0, 0, 255)			},
						{	model = 'models/golf/golf.mdl', skin = '6', 	name = 'Purple', 	color = Color(67, 12, 96, 255)		},
						{	model = 'models/golf/golf.mdl', skin = '7', 	name = 'Sky Blue', 	color = Color(0, 188, 235, 255)		},
						{	model = 'models/golf/golf.mdl', skin = '8', 	name = 'Taxi', 		color = Color(203, 173, 0, 255)		}, */
					};
...
VEHICLE.Exhaust = { 
									{Vector(-20.1605, -103.3579, 10.4373), Angle(0, 0, 80)},
						}
