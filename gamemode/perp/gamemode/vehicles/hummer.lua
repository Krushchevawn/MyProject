...
VEHICLE.HeadlightPositions 	= 	{
									{Vector(-28.8976, 131.9006, 52.8469), 	Angle(20, 0, 0)};
									{Vector(28.8976, 131.9006, 52.8469), 	Angle(20, 0, 0)};
								};
VEHICLE.TaillightPositions 	= 	{
									{Vector(-42.5302, -107.8181, 63.2093), 	Angle(20, -180, 0)};
									{Vector(42.5302, -107.8181, 63.2093), 	Angle(20, -180, 0)};
								};
...
VEHICLE.Exhaust = { 
									{Vector(-7.0419, -110.3580, 25.8460), Angle(0, 0, 80)},
						}
						
VEHICLE.RevvingSound		= "vehicles/caterham/rev_short_loop.wav";
VEHICLE.SpinoutSound		= "vehicles/golf/skid_highfriction.wav";

VEHICLE.SetCamPos = Vector(200, 300, 50)
VEHICLE.SetLookAt = Vector(0, 0, 70)
