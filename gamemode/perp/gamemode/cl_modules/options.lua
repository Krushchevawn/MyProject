...
GM.Options_WeatherEnabled = CreateClientConVar("perp2_enable_weather", "1", true, false);
...
function GM.LoadOptionsList ( panelList )
	...
	local inventoryUseAlpha = vgui.Create("DCheckBoxLabel", panelList);
	inventoryUseAlpha:SetText("Weather effects enabled?");
	inventoryUseAlpha:SetConVar("perp2_enable_weather");
	inventoryUseAlpha:SetValue(GAMEMODE.Options_WeatherEnabled:GetInt());
	panelList:AddItem(inventoryUseAlpha);
