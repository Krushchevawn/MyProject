...
local weapons = {"weapon_perp_ak472", "weapon_perp_copgun", "weapon_perp_copgun_ss", "weapon_perp_copgun_usp", "weapon_perp_deagle2", "weapon_perp_fiveseven", "weapon_perp_glock", "weapon_perp_shotgun", "weapon_perp_uzi", "weapon_perp_m4a1", "weapon_perp_mp5", "weapon_perp_copgun_mp5"}
	...
	for _, each in pairs(player.GetAll()) do
		if (each:GetPos():Distance(real) < 50) then 
			...
			if (foundGun) then
				...
				self:EmitSound("perp2.5/metal_detector.mp3", 100, 100)
				return
			end
		end
	end
